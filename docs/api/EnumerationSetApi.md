...
# **getValues**
> getValues(webId: string, selectedFields?: string, extraHttpRequestParams?: any)
...
# **createValue**
> createValue(webId: string, enumerationValue: Models.PIEnumerationValue, extraHttpRequestParams?: any)
