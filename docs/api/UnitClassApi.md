...
# **getCanonicalUnit**
> getCanonicalUnit(webId: string, selectedFields?: string, extraHttpRequestParams?: any)
...
# **getUnits**
> getUnits(webId: string, selectedFields?: string, extraHttpRequestParams?: any)
...
# **createUnit**
> createUnit(webId: string, unitDTO: Models.PIUnit, extraHttpRequestParams?: any)
