...
export class PIUnitClass {
	...
	constructor(webId?: string, id?: string, name?: string, description?: string, canonicalUnitName?: string, canonicalUnitAbbreviation?: string, path?: string, links?: { [key: string]: string; })
	{
		if (webId!=null)
		{
			this.WebId=webId
