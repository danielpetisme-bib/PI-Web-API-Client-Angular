...
export class PIUnitClass {
	...
	public Path?: string;
	public Links?: Models.PIUnitClassLinks;
	public WebException?: Models.PIWebException;
	constructor(webId?: string, id?: string, name?: string, description?: string, canonicalUnitName?: string, canonicalUnitAbbreviation?: string, path?: string, links?: Models.PIUnitClassLinks, webException?: Models.PIWebException)
	{
		if (webId!=null)
		{
			this.WebId=webId
