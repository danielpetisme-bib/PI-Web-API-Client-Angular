...
var AnalysisTemplateApi = (function () {
    function AnalysisTemplateApi(http, basePath, defaultHeaders) {
        this.http = http;
        this.basePath = null;
    ...
    AnalysisTemplateApi.prototype.createFromAnalysisWithHttpInfo = function (analysisWebId, name, webIdType, extraHttpRequestParams) {
        ...
        if ((analysisWebId !== undefined) && (analysisWebId !== null)) {
            queryParameters.set('analysisWebId', analysisWebId);
        }
    ...
    AnalysisTemplateApi.prototype.updateWithHttpInfo = function (webId, template, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/analysistemplates/{webId}'
            .replace('{' + 'webId' + '}', String(webId));
        var queryParameters = new http_1.URLSearchParams();
        var headers = new http_1.Headers(this.defaultHeaders.toJSON());
    ...
    AnalysisTemplateApi.prototype.deleteWithHttpInfo = function (webId, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/analysistemplates/{webId}'
            .replace('{' + 'webId' + '}', String(webId));
        var queryParameters = new http_1.URLSearchParams();
        var headers = new http_1.Headers(this.defaultHeaders.toJSON());
    ...
    AnalysisTemplateApi.prototype.updateSecurityEntryWithHttpInfo = function (name, webId, securityEntry, applyToChildren, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/analysistemplates/{webId}/securityentries/{name}'
            .replace('{' + 'name' + '}', String(name))
            .replace('{' + 'webId' + '}', String(webId));
        var queryParameters = new http_1.URLSearchParams();
    ...
    AnalysisTemplateApi.prototype.deleteSecurityEntryWithHttpInfo = function (name, webId, applyToChildren, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/analysistemplates/{webId}/securityentries/{name}'
            .replace('{' + 'name' + '}', String(name))
            .replace('{' + 'webId' + '}', String(webId));
        var queryParameters = new http_1.URLSearchParams();
...
AnalysisTemplateApi = __decorate([
    core_1.Injectable()
], AnalysisTemplateApi);
