...
export class ElementCategoryApi {
		...
		public getByPath(path: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PIElementCategory>  { 
		...
		public get(webId: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PIElementCategory>  { 
		...
		public update(webId: string, elementCategory: Models.PIElementCategory, extraHttpRequestParams?: any) : Observable<{}>   { 
		...
		public updateWithHttpInfo(webId: string, elementCategory: Models.PIElementCategory, extraHttpRequestParams?: any) : Observable<Response>  { 
			const localVarPath = this.basePath + '/elementcategories/{webId}'
				.replace('{' + 'webId' + '}', String(webId));
