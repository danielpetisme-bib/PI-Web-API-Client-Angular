...
export class AttributeCategoryApi {
		...
		public getByPath(path: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PIAttributeCategory>  { 
		...
		public get(webId: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PIAttributeCategory>  { 
		...
		public update(webId: string, category: Models.PIAttributeCategory, extraHttpRequestParams?: any) : Observable<{}>   { 
		...
		public updateWithHttpInfo(webId: string, category: Models.PIAttributeCategory, extraHttpRequestParams?: any) : Observable<Response>  { 
			const localVarPath = this.basePath + '/attributecategories/{webId}'
				.replace('{' + 'webId' + '}', String(webId));
