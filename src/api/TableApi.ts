...
export class TableApi {
		...
		public getByPath(path: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PITable>  { 
		...
		public get(webId: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PITable>  { 
		...
		public update(webId: string, table: Models.PITable, extraHttpRequestParams?: any) : Observable<{}>   { 
		...
		public updateWithHttpInfo(webId: string, table: Models.PITable, extraHttpRequestParams?: any) : Observable<Response>  { 
			const localVarPath = this.basePath + '/tables/{webId}'
				.replace('{' + 'webId' + '}', String(webId));
		...
		public getCategories(webId: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PIItemsTableCategory>  { 
		...
		public getData(webId: string, selectedFields?: string, extraHttpRequestParams?: any) : Observable<Models.PITableData>  { 
		...
		public getDataWithHttpInfo(webId: string, selectedFields?: string, extraHttpRequestParams?: any) : Observable<Response>  { 
		...
		public updateData(webId: string, data: Models.PITableData, extraHttpRequestParams?: any) : Observable<{}>   { 
		...
		public updateDataWithHttpInfo(webId: string, data: Models.PITableData, extraHttpRequestParams?: any) : Observable<Response>  { 
			const localVarPath = this.basePath + '/tables/{webId}/data'
				.replace('{' + 'webId' + '}', String(webId));
