...
export class AnalysisCategoryApi {
		...
		public update(webId: string, category: Models.PIAnalysisCategory, extraHttpRequestParams?: any) : Observable<{}>   { 
		...
		public updateWithHttpInfo(webId: string, category: Models.PIAnalysisCategory, extraHttpRequestParams?: any) : Observable<Response>  { 
			const localVarPath = this.basePath + '/analysiscategories/{webId}'
				.replace('{' + 'webId' + '}', String(webId));
