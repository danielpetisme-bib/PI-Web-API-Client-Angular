...
export class SecurityMappingApi {
		...
		public getByPath(path: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PISecurityMapping>  { 
		...
		public get(webId: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PISecurityMapping>  { 
		...
		public update(webId: string, securityMapping: Models.PISecurityMapping, extraHttpRequestParams?: any) : Observable<{}>   { 
		...
		public updateWithHttpInfo(webId: string, securityMapping: Models.PISecurityMapping, extraHttpRequestParams?: any) : Observable<Response>  { 
			const localVarPath = this.basePath + '/securitymappings/{webId}'
				.replace('{' + 'webId' + '}', String(webId));
