...
var TimeRulePlugInApi = (function () {
    function TimeRulePlugInApi(http, basePath, defaultHeaders) {
        this.http = http;
        this.basePath = null;
    ...
    TimeRulePlugInApi.prototype.getByPathWithHttpInfo = function (path, selectedFields, webIdType, extraHttpRequestParams) {
    ...
    TimeRulePlugInApi.prototype.getWithHttpInfo = function (webId, selectedFields, webIdType, extraHttpRequestParams) {
