...
export class BatchApi {
		...
		public execute(batch: { [key: string]: Models.PIRequest; }, extraHttpRequestParams?: any) : Observable<{[key: string]: Models.PIResponse }>  { 
			return this.executeWithHttpInfo(batch, extraHttpRequestParams)
		...
		public executeWithHttpInfo(batch: { [key: string]: Models.PIRequest; }, extraHttpRequestParams?: any) : Observable<Response>  { 
