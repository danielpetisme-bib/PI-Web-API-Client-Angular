...
export class TableCategoryApi {
		...
		public getByPath(path: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PITableCategory>  { 
		...
		public get(webId: string, selectedFields?: string, webIdType?: string, extraHttpRequestParams?: any) : Observable<Models.PITableCategory>  { 
		...
		public update(webId: string, tableCategory: Models.PITableCategory, extraHttpRequestParams?: any) : Observable<{}>   { 
		...
		public updateWithHttpInfo(webId: string, tableCategory: Models.PITableCategory, extraHttpRequestParams?: any) : Observable<Response>  { 
			const localVarPath = this.basePath + '/tablecategories/{webId}'
				.replace('{' + 'webId' + '}', String(webId));
